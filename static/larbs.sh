...
dotfilesrepo="https://github.com/ewof/rice.git"
progsfile="https://raw.githubusercontent.com/ewof/LARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
installffaddons(){
	addonlist="xbs simple-translate dont-accept-webp canvasblocker"
	addontmp="$(mktemp -d)"
...
#category-more-from-mozilla { display: none !important }" > "$pdir/chrome/userContent.css"
	[ ! -f  "$pdir/chrome/userChrome.css" ] && sudo -u "$name" echo "#nav-bar .toolbarbutton-1:not([type="menu-button"]),
...
font-family: 'UW Ttyp0' !important; font-size: 24pt }
...
#identity-box[pageproxystate="valid"] {display: none !important;}
...
#nav-bar {border-bottom: 1px solid #495D6E!important; }
...
#main-window[titlepreface*="​"] #titlebar { height: 0em !important; }
...
.toolbarbutton-1:hover {opacity:100%!important;}
.toolbarbutton-1 {opacity: 0!important;}

#sidebar-box{
  border-right: 1px solid #495D6E;
}
" > "$pdir/chrome/userChrome.css"
}
