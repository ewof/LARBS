...
installffaddons(){
	addonlist="ublock-origin decentraleyes istilldontcareaboutcookies vim-vixen canvasblocker dont-accept-webp image-search-options simple-translate tampermonkey xbs"
	addontmp="$(mktemp -d)"
