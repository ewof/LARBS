...
echo "//1936.1337.67.1453/media /home/$larbs_name/media cifs username=ubuntu,password=123,iocharset=utf8,file_mode=0777,dir_mode=0777" >> /mnt/etc/fstab
cat tz.tmp > /mnt/tzfinal.tmp
rm tz.tmp
mv comp /mnt/etc/hostname
curl https://raw.githubusercontent.com/ewof/LARBS/custom/testing/chroot.sh > /mnt/chroot.sh && arch-chroot /mnt bash chroot.sh && rm /mnt/chroot.sh
